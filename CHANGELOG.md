...
### Fixed
- Mistral: show current-month API spend in saved Icon and Percent menu-bar layouts instead of an unavailable placeholder (#2821). Thanks @selfagency for the report!
