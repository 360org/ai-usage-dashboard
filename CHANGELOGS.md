...
## [Unreleased]
- 2026-08-05 ci: bổ sung job build macOS app vào GitHub Actions CI T1.9 [bb565c67] (T1.9)
...
- 2026-08-05 docs: hoàn thiện DEPLOY_GUIDE.md hướng dẫn build và cài đặt CLI T1.5 [b0855934] (T1.5)
- 2026-08-05 docs: xây dựng ARCH.md kiến trúc hệ thống và sơ đồ Mermaid T1.4 [5a693dba] (T1.4)
- 2026-08-05 docs: xây dựng SPEC.md đặc tả kỹ thuật CodexBar T1.3 [63676423] (T1.3)
- 2026-08-05 docs: xây dựng REQUIREMENTS.md mô tả yêu cầu tính năng CodexBar T1.2 [95c3055d] (T1.2)
- 2026-08-05 docs: đồng bộ VISION.md sang IDEA.md và xóa VISION.md T1.1 [e27dae88] (T1.1)
## 0.47.1 — Unreleased
